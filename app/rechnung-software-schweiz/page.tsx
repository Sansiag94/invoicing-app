...
const copy: LandingCopy = {
  ...
  preview: {
    ...
    clientName: "Atelier Beispiel GmbH",
    totalLabel: "Faelliger Betrag",
    totalValue: "CHF 690.00",
    dueLabel: "Faellig am",
    dueValue: "30.06.2026",
    qrTitle: "Schweizer QR-Rechnung",
    qrText: "Der Zahlungsteil steht unten auf der Rechnung und ist fuer Schweizer Bankueberweisungen vorbereitet.",
    paymentReference: "QR-Referenz enthalten",
    lineHeaders: ["Beschreibung", "Anz.", "Total"],
    callouts: {
      logo: "Ihr Logo und Ihre Absenderdaten",
      details: "Leistungen, Mengen, Rabatte und Totale",
      qr: "QR-Code mit Ihren Bankangaben",
      reference: "Zahlungsreferenz fuer den Abgleich",
    },
    rows: [
      { label: "Beratungstermin", client: "Projektunterstuetzung", value: "CHF 360", status: "3" },
      { label: "Monatliches Servicepaket", client: "Laufende Arbeit", value: "CHF 280", status: "1" },
      { label: "Rabatt fuer Neukunden", client: "Manueller Rabatt", value: "- CHF 50", status: "1" },
    ],
  },
  proof: [
