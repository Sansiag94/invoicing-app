...
const copy: LandingCopy = {
  ...
  preview: {
    ...
    invoiceMeta: "SI2026-024",
    clientLabel: "Bill to",
    clientName: "Sample Client AG",
    totalLabel: "Amount due",
    totalValue: "CHF 690.00",
    dueLabel: "Due date",
    dueValue: "30.06.2026",
    qrTitle: "Swiss QR-bill",
    qrText: "The detachable payment part includes account, amount, payer details, and QR reference.",
    paymentReference: "Reference: 00 00000 00000 00000 00000 00000",
    receiptTitle: "Receipt",
    paymentPartTitle: "Payment part",
    accountLabel: "Account / Payable to",
    payableToLabel: "Payable to",
    payableByLabel: "Payable by",
    currencyLabel: "Currency / Amount",
    subjectLabel: "Subject",
    subjectValue: "Services June 2026",
    lineHeaders: ["Pos.", "Description", "Qty", "Unit price", "Amount"],
    callouts: {
      logo: "Your logo and sender details",
      details: "Professional service table with quantities and prices",
      qr: "Clear invoice totals before sending",
      reference: "Separate Swiss QR payment slip included",
    },
    rows: [
      { position: "1", label: "Consulting session", quantity: "3.00", unitPrice: "120.00", value: "360.00" },
      { position: "2", label: "Monthly service package", quantity: "1.00", unitPrice: "280.00", value: "280.00" },
