...
const copy: LandingCopy = {
  ...
  preview: {
    ...
    lineHeaders: ["Description", "Qty", "Total"],
    callouts: {
      logo: "Your logo and sender details",
      details: "Services, quantities, discounts, and totals",
      qr: "Swiss QR-bill payment part at the bottom",
      reference: "QR reference helps match incoming payments",
    },
    rows: [
      { label: "Consulting session", client: "Project support", value: "CHF 360", status: "3" },
      { label: "Monthly service package", client: "Ongoing work", value: "CHF 280", status: "1" },
      { label: "New client discount", client: "Manual discount", value: "- CHF 50", status: "1" },
    ],
  },
  proof: [
