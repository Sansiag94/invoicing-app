...
const copy: LandingCopy = {
  ...
  preview: {
    ...
    qrText: "The payment section sits at the bottom of the invoice, ready for Swiss bank transfer workflows.",
    paymentReference: "QR reference included",
    lineHeaders: ["Description", "Qty", "Total"],
    callouts: {
      logo: "Your logo and sender details",
      details: "Services, quantities, discounts, and totals",
      qr: "QR code linked to your bank details",
      reference: "Payment reference for matching payments",
    },
    rows: [
